...
# 화면에 함께 렌더링되는 라벨과 값
labels: [ROLE, STACK]
role: BMT 인프라 단독 전담 · Kubernetes 리소스·네트워크 구조 설계
stack: Kubernetes · vLLM · Gemma4-31B-it · AWS H100 · Linux (RHEL)
reference_text: MORE DETAILS · https://geo-portfolio.co.kr/projects/insurance-bmt-infra
